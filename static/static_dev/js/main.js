...
$(document).ready(function() {
    ...
    $(document).on('click', '.add-to-cart-btn', function(e) {
        ...
        try {
            ...
            if (window.BelizziCart && typeof window.BelizziCart.add === 'function') {
                window.BelizziCart.add(productId, productName, productPrice, productCategory);
            } else {
    ...
    // Toggle quick checkout drawer when clicking the dash - only if not already handled
    if ($('.dash-to-open').data('event-attached') !== true) {
        $('.dash-to-open').data('event-attached', true);
    ...
    // Go to checkout page when clicking the Order button - only if not already handled
    if ($('.checkout-button').data('event-attached') !== true) {
        $('.checkout-button').data('event-attached', true);
    ...
    window.debugBelizzi = function() {
        ...
        console.log("BelizziCart object exists:", typeof window.BelizziCart === 'object');
